...
export default function EditKitBMR() {
    ...
    useEffect(() => {
        const fetchRecord = async () => {
            ...
            try {
                ...
                console.log('Edit Kit - Raw DB:', data);
                console.log('Edit Kit - Mapped:', mapped);
                setRecord(mapped);
            } catch (error: any) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            <div className="p-4 bg-white border-b shadow-sm sticky top-0 z-20 flex justify-between items-center">
                ...
                <div className="text-gray-500 font-bold">Editing Kit BMR — Batch: {record?.batchNo}</div>
            </div>
