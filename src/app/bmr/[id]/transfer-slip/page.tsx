...
import MaterialTransferSlip from '@/components/slips/MaterialTransferSlip';
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-screen">
                <Spin size="large" tip="Generating Transfer Slip..." />
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="p-4 bg-gray-50 border-b no-print flex justify-between items-center sticky top-0 z-20">
                ...
                <div className="text-gray-500 font-bold">Material Transfer Slip: {record?.batchNo}</div>
            </div>

            <div className="print-content">
                <MaterialTransferSlip data={record!} />
            </div>
        </div>
    );
}
